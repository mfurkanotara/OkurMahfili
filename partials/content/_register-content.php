		...
		<div class="card">
			<div class="card-header">
				...
				<div class="d-flex justify-content-end social_icon">
					<a href="../index.php"><span><i class="bi bi-house-door-fill"></i></span></a>
			...
			<div class="card-body">
				<form>
                    ...
                    <div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="bi bi-envelope-fill"></i></i></span>
						</div>
					...
					<div class="form-group">
						<input type="submit" value="Kayıt Ol" class="btn float-right register_btn">
					</div>
				</form>
			</div>
...
html,body{
background-image: url('http://localhost/OkurMahfili/photos/logo/OkurMahfili.png');
